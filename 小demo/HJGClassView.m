...
@interface HJGClassView()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong) UITableView *careerTab;

@end
@implementation HJGClassView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"这是第%ld个课程哈哈哈",indexPath.row];
    return cell;
}
